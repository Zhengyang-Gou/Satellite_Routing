...
from trainers.sl_trainer import train_supervised_learning_from_config
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train supervised satellite routing policy.")
    parser.add_argument(
        "--config",
        type=str,
        required=True,
        help="Path to supervised learning YAML config file.",
    )
...
def main() -> None:
    ...
    train_supervised_learning_from_config(cfg=cfg, run_dir=run_dir)
